...
export interface QueryUpcoming_showcase_freeGames_highlight_background {
  __typename: "UploadFile";
  url: string;
}

export interface QueryUpcoming_showcase_freeGames_highlight_floatImage {
  __typename: "UploadFile";
  url: string;
}

export interface QueryUpcoming_showcase_freeGames_highlight {
  __typename: "ComponentPageHighlight";
  title: string;
  subtitle: string;
  background: QueryUpcoming_showcase_freeGames_highlight_background | null;
  floatImage: QueryUpcoming_showcase_freeGames_highlight_floatImage | null;
  buttonLabel: string;
  buttonLink: string;
  alignment: ENUM_COMPONENTPAGEHIGHLIGHT_ALIGNMENT | null;
}

export interface QueryUpcoming_showcase_freeGames {
  __typename: "ComponentPageSection";
  title: string | null;
  highlight: QueryUpcoming_showcase_freeGames_highlight | null;
}

export interface QueryUpcoming_showcase {
  __typename: "Home";
  upcomingGames: QueryUpcoming_showcase_upcomingGames | null;
  freeGames: QueryUpcoming_showcase_freeGames | null;
}
